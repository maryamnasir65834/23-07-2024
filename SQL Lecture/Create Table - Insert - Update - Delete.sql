...
VALUES
       ('Smartphone', 'A latest model smartphone', 699.99, GETDATE()),
       ('SmartWatch', 'A high-performance watch', 599.99, GETDATE()),
       ('Tablet', 'A portable tablet', 499.99, GETDATE()),
       ('Headphones', 'Noise-cancelling headphones', 199.99, GETDATE());
